...
#AE_CFLAGS=-std=c99 -O2 -Wall -fstack-protector-all -Wno-pointer-sign
AE_CFLAGS=-std=c11 -Ofast -fomit-frame-pointer -m68080 -Wall -Wno-unused-function -Wno-pointer-sign
